                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form" action="{{ route('promotion.create') }}" method="POST">
                                @csrf
                                <input class="form-control mb-2" type="strig" name='name' placeholder="Акция">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form" action="{{ route('promotion.edit') }}" method="POST">
                                                ...
                                                <input class="form-control mb-2" type="strig" name='name' placeholder="Акция" value="{{ $item->name}}">
